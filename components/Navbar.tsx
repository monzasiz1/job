  ...
  return (
    <nav className="pub-nav">
      <Link href="/" className="pub-nav-logo">
        <div style={{ width: 32, height: 32, background: 'linear-gradient(135deg, #c8a951, #e2c46e)', borderRadius: 9, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div className="pub-nav-ctas">
        {user ? (
          <>
            ...
            {role === 'employer' && <Link href="/post-job" className="btn btn-gold btn-sm">+ Stelle inserieren</Link>}
          </>
        ) : (
          <>
