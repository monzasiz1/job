      ...
      <div style={{ padding: 'clamp(1rem, 4vw, 1.5rem)', maxWidth: 640, margin: '0 auto' }}>
        ...
        <SettingsSection title="Profil">
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 16 }}>
            <div style={{
              ...
              fontWeight: 700, fontSize: '0.85rem', color: 'rgba(255,255,255,0.6)', overflow: 'hidden', flexShrink: 0,
            }}>
              {profile?.avatar_url
          ...
          <Link href="/dashboard/profil" style={{
            ...
            padding: '12px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.08)',
            borderRadius: 8, color: 'rgba(255,255,255,0.6)', fontWeight: 600, fontSize: '0.85rem', textDecoration: 'none',
          }}>Profil bearbeiten</Link>
        </SettingsSection>

        {/* ZAHLUNGSKONTO */}
        <SettingsSection title="Zahlungskonto">
          <StripeOnboarding />
        ...
        <SettingsSection title="Konto">
          <button onClick={handleLogout} style={{
            width: '100%', padding: '14px', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 8,
...
function SettingsSection({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div style={{
      ...
      borderRadius: 10, padding: 'clamp(1rem, 3vw, 1.25rem)', marginBottom: 14,
    }}>
      <div style={{
        fontWeight: 600, fontSize: '0.78rem', color: 'rgba(255,255,255,0.45)',
        marginBottom: 14,
