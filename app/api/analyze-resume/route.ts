  ...
  try {
    const res = await fetch('https://api.mistral.ai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'system',
          content: 'Du bist ein erfahrener HR-Experte. Antworte NUR mit validem JSON, kein Markdown.'
        }, {
          role: 'user',
          content: `Analysiere diesen Lebenslauf auf Deutsch. Antworte NUR mit diesem JSON:
